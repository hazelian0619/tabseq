...
class FeatureTokenizer(nn.Module):
    ...
    def __init__(self, n_num_features: int, *, cat_cardinalities: Optional[List[int]]=None, d_model: int=64):
        super().__init__()
        ...
        self.cat_embs = nn.ModuleList([nn.Embedding(cardinality, self.d_model) for cardinality in self.cat_cardinalities])
